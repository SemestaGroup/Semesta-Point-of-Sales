...
import 'package:semesta_pos/modules/category/controllers/category_controller.dart';
                    ...
                    children: [
                      ListTile(
                        ...
                        title: Text(
                          'Kategori',
                          style:
                              TextStyle(fontFamily: 'popsem', fontSize: 32.sp),
                        ),
                        subtitle: Text(
                          'Halaman untuk menambahkan kategori baru.',
                          style:
                              TextStyle(fontFamily: 'popreg', fontSize: 18.sp),
                        ),
                      ),
                      SizedBox(
                        height: 10.h,
                        ...
                        ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return ListTile(
                              ...
                              title: Text(
                                categoryList.namaKategori.toString(),
                                style: TextStyle(
                                    fontFamily: 'popmed',
                                    color: Colors.black,
                                    fontSize: 20.sp),
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      Text(
                        "Tambah Kategori",
                        style: TextStyle(fontFamily: 'popsem', fontSize: 22.sp),
                      ),
                      SizedBox(
                        height: 15.h,
                      ),
