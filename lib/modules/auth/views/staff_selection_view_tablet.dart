...
class StaffSelectionViewTablet extends StatelessWidget {
  final AuthController controller;

  const StaffSelectionViewTablet({super.key, required this.controller});
                  ...
                  Container(
                    ...
                    child: DropdownButtonHideUnderline(
                      child: Obx(() => DropdownButton<String>(
                            ...
                            icon: Icon(CupertinoIcons.chevron_down, size: 18.sp, color: AppTheme.secondaryTextColor(context)),
                            style: TextStyle(
                              fontFamily: AppTheme.fontMedium,
                              fontSize: 14.sp,
                              color: AppTheme.textColor(context),
                    ...
                    children: [
                      Expanded(
                        child: OutlinedButton(
                          ...
                          child: Text('Cancel', style: TextStyle(fontFamily: AppTheme.fontMedium, fontSize: 15.sp)),
                        ),
                      ),
                      const SizedBox(width: 12.0),
                      Expanded(
                              ...
                              child: controller.isAddingStaff.value
                                  ...
                                  : Row(
                                      ...
                                      children: [
                                        ...
                                        const SizedBox(width: 8.0),
                                        Text('Add Staff', style: TextStyle(fontFamily: AppTheme.fontBold, fontSize: 15.sp)),
                                      ],
                                    ),
                            )),
                      ),
