...
class HomeScreenTablet extends StatelessWidget {
  ...
  const HomeScreenTablet({super.key, required this.controller});
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                // Use Flexible instead of Expanded so the dialog wraps content height naturally when data is small
                Flexible(
                  child: SingleChildScrollView(
                    physics: const BouncingScrollPhysics(),
